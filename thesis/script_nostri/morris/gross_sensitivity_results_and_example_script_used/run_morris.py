...
TOP_N_PARAMS      = 15                            # parameters shown in per-metric bar charts
...
METRIC_NAMES = [
    ...
    "cost_fil_plants", "cost_import_sea", "cost_pre_bottling", "cost_res_shop",
    "cost_source", "cost_sts", "cost_storage", "cost_storage_second",
    "cost_total", "cost_transport_filling_points_to_reseller_points",
    "cost_transport_primary_storage_to_filling_points",
    "cost_transport_primary_storage_to_primary_storage",
    "cost_transport_supply_to_primary_storage",
]
